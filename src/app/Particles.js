...
export default class Particles {
  ...
  show(duration = 1.0) {
    TweenLite.to(this.particles.material.uniforms.uRandom, duration, {value: 2.0});
    TweenLite.fromTo(this.particles.material.uniforms.uSize, duration, {value: 0.5}, {value: 1.2});
    TweenLite.fromTo(this.particles.material.uniforms.uDepth, duration, {value: 40.0}, {value: 4.0});
    this.addListeners();
  }

  hide(duration = 0.8) {
    return new Promise((resolve, reject) => {
      TweenLite.to(this.particles.material.uniforms.uSize, duration, {value: 0.0});
      TweenLite.to(this.particles.material.uniforms.uRandom, duration, {
        value: 5.0,
        onComplete: () => {
          this.destroy();
          resolve();
  ...
  destroy() {
    ...
    this.hitPlane.parent.remove(this.hitPlane);
